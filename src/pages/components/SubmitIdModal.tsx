            ...
            <div className="p-10 bg-white rounded-xl z-5">
                ...
                <form className="mt-8 space-y-3" onSubmit={handleSubmit}>
                    ...
                    <div>
                        <button
                            type="submit"
                            className="my-5 w-full flex justify-center bg-tr-0 text-gray-100 p-4 rounded-full tracking-wide font-semibold focus:outline-none focus:shadow-outline hover:bg-darkTR-0 shadow-lg cursor-pointer transition ease-in duration-300 hover:border-darkTR-0"
                        >
                            Upload
                        </button>
                    </div>
