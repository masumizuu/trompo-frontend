...
import { UserVerificationModalProps } from "../../../interfaces";
import CustomAlert from "../../components/CustomAlert";

const UserVerificationModal: React.FC<UserVerificationModalProps> = ({ verification, onClose, onAction }) => {
    ...
    const handleAction = (action: "APPROVED" | "DENIED") => {
        ...
        setAlert({
            ...
            onConfirm: () => {
                onAction(verification.verification_id, action, denialReason);
                setAlert(null);
            },
        });
    };
        ...
        <div className="py-12 bg-black bg-opacity-50 transition duration-150 ease-in-out z-10 fixed inset-0 flex items-center justify-center">
            <div className="container mx-auto w-11/12 md:w-2/3 max-w-lg">
                <div className="relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
                    <h2 className="text-tr-0 font-bold tracking-normal leading-tight mb-4">User Verification Request</h2>

                    <p className="text-gray-800 text-sm font-bold leading-tight tracking-normal">User</p>
                    ...
                    <p className="mb-4 mt-2 text-gray-600">{verification.status}</p>
                    ...
                    <div className="mb-4 mt-2">
                        <img
                            ...
                            alt="User ID"
                            className="border rounded w-full h-full object-cover cursor-pointer"
                            onClick={() => setSelectedImage(verification.id_image)}
                        />
                    </div>
