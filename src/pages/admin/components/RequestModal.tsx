        ...
        <div className="py-12 bg-black bg-opacity-50 transition duration-150 ease-in-out z-10 fixed inset-0 flex items-center justify-center">
            <div className="container mx-auto w-11/12 md:w-2/3 max-w-lg">
                <div className="relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
                    <h2 className="text-tr-0 font-bold tracking-normal leading-tight mb-4">Verification Request</h2>

                    <p className="text-gray-800 text-sm font-bold leading-tight tracking-normal">Business Name</p>
                    <p className="mb-4 mt-2 text-gray-600">{request.Business.business_name}</p>

                    <p className="text-gray-800 text-sm font-bold leading-tight tracking-normal">Request Date</p>
                    <p className="mb-4 mt-2 text-gray-600">{new Date(request.request_date).toLocaleDateString()}</p>

                    <p className="text-gray-800 text-sm font-bold leading-tight tracking-normal">Verification Document</p>
                    <div className="mb-4 mt-2">
                        <img src={request.business_permit} alt="Business Permit" className="border rounded w-full h-40 object-cover" />
                    </div>

                    <div className="mt-6">
                        <label className="text-gray-800 text-sm font-bold leading-tight tracking-normal">Reason for Denial</label>
                        <textarea
                            value={denialReason}
